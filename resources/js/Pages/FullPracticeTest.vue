                    ...
                    <div class="p-6 sm:p-10">
                        <div class="prose dark:prose-invert max-w-none">
                            <p class="text-xl text-gray-600 dark:text-gray-300 mb-8">
                                Welcome to the Full Practice Tests. These comprehensive assessments cover all areas of the CCAT, including verbal reasoning, math and logic, and spatial reasoning. It's designed to give you a complete practice experience exactly like the actual test.
                            </p>

                            <div class="bg-blue-50 dark:bg-blue-900 p-6 rounded-lg mb-12">
                                <h3 class="text-2xl font-semibold text-blue-800 dark:text-blue-200 mb-4">Table of Contents</h3>
                                <ul class="space-y-2 list-none">
                                    <li v-for="section in sections" :key="section.id">
                                        <a :href="`#${section.id}`" class="flex items-center text-blue-600 dark:text-blue-300 hover:text-blue-800 dark:hover:text-blue-100 transition-colors duration-200">
                            ...
                            <section v-for="section in sections" :key="section.id" :id="section.id" class="mb-12">
                                <h2 class="text-3xl font-bold text-gray-800 dark:text-gray-100 mb-6">{{ section.title }}</h2>
                                ...
                                <div v-else-if="section.id === 'instructions'">
                                    <ol class="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-300">
                                        ...
                                        <li>Your score will be displayed immediately after completing the test along with the answers for the incorrect responses.</li>
                                    </ol>
                                </div>
                                ...
                                <div v-else-if="section.id === 'available-tests'">
                                    <p class="mb-6 text-gray-600 dark:text-gray-300">We offer multiple full practice tests to help you prepare thoroughly. Each test contains a unique set of questions while maintaining the same structure and difficulty level. Choose any test below to begin:</p>
                                    ...
                                    <div class="mt-8 flex justify-center">
                                        <Link :href="route('full-practice-test-start')"
                                              class="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition duration-300 text-lg font-semibold">
                                            Start Randomized Test
                                        </Link>
                                    </div>
                                    <p class="text-center mt-4 text-sm text-gray-600 dark:text-gray-400">
                                        (Generates Random Questions from our pool of questions)
                                    </p>
                                </div>
                            </section>
                        </div>
