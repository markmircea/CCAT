...
const selectQuestions = () => {
    ...
    const test2Questions = [...allQuestions.value.test2].sort(() => 0.5 - Math.random()).slice(0, 15);

    // Select 35 random questions from the other files
    const otherQuestions = [...allQuestions.value.others].sort(() => 0.5 - Math.random()).slice(0, 35);
