            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="p-6 sm:px-20 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                            ...
                            <h1 class="text-3xl font-bold mb-6 text-gray-900 dark:text-gray-100 text-center">Free Practice Test: 25 Questions</h1>
                            <div class="space-y-4 text-gray-600 dark:text-gray-400">
                                <p class="mb-4">You will have <span class="font-semibold text-gray-800 dark:text-gray-200">7:30 minutes</span> to complete the test. This free assessment measures your aptitude in areas such as critical thinking and problem-solving. It provides a glimpse into the full CCAT experience.</p>
                                ...
                                <div class="bg-yellow-50 dark:bg-yellow-900 p-4 rounded-lg">
                                    ...
                                    <ul class="list-disc list-inside space-y-2 text-yellow-700 dark:text-yellow-300">
                                        ...
                                        <li>Avoid leaving the assessment window or switching your browser tab during the test.</li>
                                    </ul>
                                </div>
                        ...
                        <div v-else class="text-center">
                            ...
                            <div v-for="(question, index) in questions" :key="question.id" class="mb-8 text-left">
                                ...
                                <p v-if="userAnswers[index] !== question.correctAnswer" class="mt-2 text-red-600 dark:text-red-400">
