...
const page = usePage();
const currentRoute = computed(() => page.props.component);
...
//console.log('DynamicSEO Component - Computed Canonical URL:', canonicalUrl.value);
//console.log('DynamicSEO Component - Computed OG Image:', ogImage.value);
</script>
